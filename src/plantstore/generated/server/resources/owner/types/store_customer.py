...
from ....core.datetime_utils import serialize_as_utc
...
class StoreCustomer(pydantic.BaseModel):
    ...
    class Partial(typing_extensions.TypedDict):
        ...
        created_time: typing_extensions.NotRequired[typing.Optional[datetime.datetime]]
    ...
    class Config:
        ...
        json_encoders = {
            datetime: lambda v: serialize_as_utc(v),
        }
